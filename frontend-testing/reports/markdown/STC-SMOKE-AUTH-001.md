...
|-------|--------|-------|--------|
| **Project** *(required)* | Application under test | **STC ID** *(required)* | STC-SMOKE-AUTH-001 |
| **Test Suite ID** | | **Requirement ID** | |
| **Module / Component** | Authentication � Smoke | **Feature Name** | Smoke � login page loads |
| **Sprint ID** | Sprint 1 | **Release ID** | |
| **Build Number** |  | **API Version** |  |
| **Traceability Ref** | STC-SMOKE-AUTH-001 | **Compliance Impact** | - [ ] Yes - [ ] No - [ ] Partial |

**User Story** *(As a [role], I want to ... so that ...)*

Smoke � login page loads
...
| **Execution Duration** | 00:03 | **Execution Cycle** | *(e.g. Cycle 1 / UAT)* |
...
*Playwright ? 2026-06-07T17:38:00.968Z ? Duration 2858ms ? Project chromium-guest ? Tester GitHub Actions*
