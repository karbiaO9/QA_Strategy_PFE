...
## Test Case - XXX&Connect — STC-PROFILE-UPDATE-005B

| Field | Value |
|-------|--------|
| **Project** | XXX&Connect |
| **STC ID** | STC-PROFILE-UPDATE-005/B |
| **USER STORY** |  |
...
### TEST SCRIPT STEPS / RESULTS - STC-PROFILE-UPDATE-005/B | Patch immutable field ignored or 400

| ID | ACTION / TEST STEP | TEST DATA | EXPECTED RESULTS | ACTUAL RESULTS | ACCEPTANCE CRITERIA | PASS/FAIL | BUG ID | SEVERITY |
|----|--------------------|-----------|------------------|----------------|------------------------|-----------|--------|----------|
| 1 | Execute PATCH request for STC-PROFILE-UPDATE-005B (STC-PROFILE-UPDATE-005/B \| Patch immutable field ignored or 400) | PATCH https://identity.physio.agregatech.com/api/v1/kine/profiles/6a04a5695097a1ea13a2a999 \| Body: { "email": "hacker@evil.com" } \| Headers: Content-Type: application/json; Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2YTA0YTU2OTUwOTdhMWVhMTNhMmE5OTMiLCJlbWFpbCI6InNvcGhpZS5tYXJ0aW5AY2FiaW5ldC1wYXJpcy5mciIsInR5cGUiOiJraW5lIiwiY2FiaW5ldElkIjpudWxsLCJyb2xlU2x1ZyI6IiIsInYiOjgsImlhdCI… | HTTP 400; response matches acceptance for specified story. | 400 Bad Request in 82 ms 1 assertion(s) passed. Body keys: code: FIELD_NOT_APPLICABLE; message: Unknown or non-mutable field(s): email.; fields: {…}; statusCode: 400; error: BadRequestException | Per Sprint 1 backend execution specification. | PASS |  |  |
