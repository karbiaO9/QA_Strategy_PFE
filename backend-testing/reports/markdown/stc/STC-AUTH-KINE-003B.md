...
|----|--------------------|-----------|------------------|----------------|------------------------|-----------|--------|----------|
| 1 | Execute POST request for STC-AUTH-KINE-003B (STC-AUTH-KINE-003/B \| Kine login wrong password 401) | POST https://identity.physio.agregatech.com/api/v1/kine/auth/login \| Body: { "email": "sophie.martin@cabinet-paris.fr", "password": "WrongP@ssword1!" } \| Headers: Content-Type: application/json | • Response status code : HTTP 401 • Body contains : { "statusCode": 401, "error": "...", "code": "Unauthorized (token invalid / credentials incorrects)" } • No side effects in database Execution sheet: HTTP ∈ {401}. Newman: expect HTTP 401. | 401 Unauthorized in 364 ms 2 assertion(s) passed. Body keys: code: INVALID_CREDENTIALS; message: Invalid credentials.; statusCode: 401; error: UnauthorizedException | HTTP 401 | PASS |  |  |
