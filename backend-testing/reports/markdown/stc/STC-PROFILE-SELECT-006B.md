...
|----|--------------------|-----------|------------------|----------------|------------------------|-----------|--------|----------|
| 1 | Execute POST request for STC-PROFILE-SELECT-006B (STC-PROFILE-SELECT-006/B \| Select inactive profile 403) | POST https://identity.physio.agregatech.com/api/v1/kine/auth/select-profile \| Body: { "profileId": "" } \| Headers: Content-Type: application/json | • Response status code : HTTP 403 • Body contains : { "statusCode": 403, "error": "...", "code": "PROFILE_INACTIVE" } • No side effects in database Execution sheet: HTTP ∈ {403}. | 400 Bad Request in 62 ms 1 failed, 2 passed. expected 'VALIDATION_FAILED' to deeply equal 'PROFILE_INACTIVE' Body keys: code: VALIDATION_FAILED; message: Request payload is invalid.; errors: {…}; statusCode: 400; error: BadRequestException expected 'VALIDATION_FAILED' to deeply equal 'PROFILE_INACTIVE' | HTTP 403 PROFILE_INACTIVE | FAIL | BUG-PROFILE-003 | Medium |
