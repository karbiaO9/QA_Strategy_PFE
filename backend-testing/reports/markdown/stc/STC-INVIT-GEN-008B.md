...
## Test Case - XXX&Connect — STC-INVIT-GEN-008B

| Field | Value |
|-------|--------|
| **Project** | XXX&Connect |
| **STC ID** | STC-INVIT-GEN-008/B |
| **USER STORY** |  |
...
| Field | Value |
|-------|--------|
| **Purpose:** | Validate POST https://identity.physio.agregatech.com/api/v1/kine/auth/invitations per test specification. |
