...
## Test Case - XXX&Connect — STC-PROFILE-SELECT-008B

| Field | Value |
|-------|--------|
| **Project** | XXX&Connect |
| **STC ID** | STC-PROFILE-SELECT-008/B |
| **USER STORY** |  |
...
### TEST SCRIPT STEPS / RESULTS - STC-PROFILE-SELECT-008/B | Select profile not owned 403/404

| ID | ACTION / TEST STEP | TEST DATA | EXPECTED RESULTS | ACTUAL RESULTS | ACCEPTANCE CRITERIA | PASS/FAIL | BUG ID | SEVERITY |
|----|--------------------|-----------|------------------|----------------|------------------------|-----------|--------|----------|
| 1 | Execute POST request for STC-PROFILE-SELECT-008B (STC-PROFILE-SELECT-008/B \| Select profile not owned 403/404) | POST https://identity.physio.agregatech.com/api/v1/kine/auth/select-profile \| Body: { "profileId": "65f0000000000000000000ff" } \| Headers: Content-Type: application/json; Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2YTA0YTU2OTUwOTdhMWVhMTNhMmE5OTMiLCJlbWFpbCI6InNvcGhpZS5tYXJ0aW5AY2FiaW5ldC1wYXJpcy5mciIsInR5cGUiOiJraW5lIiwiY2FiaW5ldElkIjpudWxsLCJyb2xlU2x1ZyI6IiIsInYiOjgsImlhdCI… | HTTP 404; response matches acceptance for specified story. | 404 Not Found in 104 ms 1 assertion(s) passed. Body keys: code: PROFILE_NOT_FOUND; message: …; statusCode: 404; error: NotFoundException | Per Sprint 1 backend execution specification. | PASS |  |  |
