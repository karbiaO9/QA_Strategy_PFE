...
|----|--------------------|-----------|------------------|----------------|------------------------|-----------|--------|----------|
| 1 | Execute PATCH request for STC-PROFILE-UPDATE-002B (STC-PROFILE-UPDATE-002/B \| Patch unknown profile 404) | PATCH https://identity.physio.agregatech.com/api/v1/kine/profiles/65f0000000000000000000ff \| Body: /path/65f0000000000000000000ff \| Headers: Content-Type: application/json | • Response status code : HTTP 404 • Body contains : { "statusCode": 404, "error": "...", "code": "PROFILE_NOT_FOUND" } • No side effects in database Execution sheet: HTTP ∈ {404}. | 400 Bad Request in 153 ms 3 assertion(s) passed. Body keys: message: …; error: Bad Request; statusCode: 400 | HTTP 404 PROFILE_NOT_FOUND | PASS |  |  |
