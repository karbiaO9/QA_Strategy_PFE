...
| Field | Value |
|-------|--------|
| **Summary** | STC-PROFILE-UPDATE-001B: STC-PROFILE-UPDATE-001/B \| Patch profile allowed fields — assertion failure (HTTP 401 Unauthorized). expected [ 200, 201 ] to include 401 |
...
| **Actual Result** | 401 Unauthorized in 154 ms. 1 failed, 1 passed. expected [ 200, 201 ] to include 401 — expected [ 200, 201 ] to include 401 |
...
| Field | Value |
|-------|--------|
| **Notes** | expected [ 200, 201 ] to include 401 |
