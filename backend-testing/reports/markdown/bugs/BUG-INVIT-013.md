...
| Field | Value |
|-------|--------|
| **ID Number#** | BUG-INVIT-013 |
| **Title** | STC-INVIT-ATTACH-004B: POST — Attach consumed token 409 |
...
| Field | Value |
|-------|--------|
| **Summary** | STC-INVIT-ATTACH-004B: STC-INVIT-ATTACH-004/B \| Attach consumed token 409 — HTTP 400 Bad Request; Excel-allowed HTTP {409}. Also: expected [ 409, 401 ] to include 400 |
| **Test Data** | POST https://identity.physio.agregatech.com/api/v1/kine/auth/invitations/attach \| Body: { "invitationToken": "", "password": "QaTest123!" } \| Headers: Content-Type: application/json |
...
| **Actual Result** | 400 Bad Request in 82 ms. 1 failed, 0 passed. expected [ 409, 401 ] to include 400 — expected [ 409, 401 ] to include 400 |
...
| Field | Value |
|-------|--------|
| **Notes** | expected [ 409, 401 ] to include 400 \| Excel Expected Result requires HTTP in {409}; received 400. |
