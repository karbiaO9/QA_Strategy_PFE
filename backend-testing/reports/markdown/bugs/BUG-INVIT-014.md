...
| Field | Value |
|-------|--------|
| **ID Number#** | BUG-INVIT-014 |
| **Title** | STC-INVIT-ATTACH-001B: POST — Attach existing user (manual token) |
...
| Field | Value |
|-------|--------|
| **Summary** | STC-INVIT-ATTACH-001B: STC-INVIT-ATTACH-001/B \| Attach existing user (manual token) — assertion failure (HTTP 400 Bad Request). expected [ 201, 401, 409 ] to include 400 |
...
| **Actual Result** | 400 Bad Request in 78 ms. 1 failed, 0 passed. expected [ 201, 401, 409 ] to include 400 — expected [ 201, 401, 409 ] to include 400 |
...
| Field | Value |
|-------|--------|
| **Notes** | expected [ 201, 401, 409 ] to include 400 |
