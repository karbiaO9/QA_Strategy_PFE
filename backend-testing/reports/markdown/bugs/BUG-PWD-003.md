...
| Field | Value |
|-------|--------|
| **Summary** | STC-PWD-CHANGE-001B: STC-PWD-CHANGE-001/B \| Change password success — assertion failure (HTTP 400 Bad Request). expected response to have status code 200 but got 400 |
...
| **Actual Result** | 400 Bad Request in 272 ms. 1 failed, 1 passed. expected response to have status code 200 but got 400 — expected response to have status code 200 but got 400 |
