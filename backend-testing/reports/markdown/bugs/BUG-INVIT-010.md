...
| **Title** | STC-INVIT-ACCEPT-006B: POST — Accept corrupted JWT 401 |
...
| Field | Value |
|-------|--------|
| **Summary** | STC-INVIT-ACCEPT-006B: STC-INVIT-ACCEPT-006/B \| Accept corrupted JWT 401 — HTTP 400 Bad Request; Excel-allowed HTTP {401}. Also: expected response to have status code 401 but got 400 |
| **Test Data** | POST https://identity.physio.agregatech.com/api/v1/kine/auth/accept-invitation \| Body: { "invitationToken": "corrupted.jwt.token", "firstName": "Jean", "lastName": "Dupuis", "password": "KineAdmin123!", "passwordConfirmation": "KineAdmin123!", "cguAccepted": true } \| Headers: Content-Type: application/json |
...
| **Actual Result** | 400 Bad Request in 153 ms. 1 failed, 1 passed. expected response to have status code 401 but got 400 — expected response to have status code 401 but got 400 |
